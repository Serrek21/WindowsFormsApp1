...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeIcons()
        {
            ...
            zombieIcon = Image.FromFile("C:\\Users\\Serek\\Desktop\\WindowsFormsApp1\\WindowsFormsApp1\\img\\zombieIcon.png");
            magicTowerIcon = Image.FromFile("C:\\Users\\Serek\\Desktop\\WindowsFormsApp1\\WindowsFormsApp1\\img\\magicTowerIcon.png");
            archerTowerIcon = Image.FromFile("C:\\Users\\Serek\\Desktop\\WindowsFormsApp1\\WindowsFormsApp1\\img\\archerTowerIcon.png");
            knightTowerIcon = Image.FromFile("C:\\Users\\Serek\\Desktop\\WindowsFormsApp1\\WindowsFormsApp1\\img\\knightTowerIcon.png");
        }
        ...
        private void RestartGame()
        {
            ...
            InitializeGame();
            MessageBox.Show("Гру перезапущено!");
            UpdateCurrencyLabel();
            Invalidate();
        }
        ...
        private void ZombieKilled(Zombie zombie)
        {
            ...
            {
                btnSuperAbility.Enabled = true; // Activates the super ability button
                MessageBox.Show("Super ability is ready to use!");
            }

            UpdateCurrencyLabel(); // Update coins or other resources
        }
        private void ActivateSuperAbility()
        {
            if (zombiesKilled < zombiesToChargeSuperAbility)
            {
                MessageBox.Show("Суперспособность еще не готова!");
                return;
            }
            ...
            MessageBox.Show("Суперспособность активована");
        }
        ...
        private void UpgradeFarm()
        {
            ...
            else
            {
                if (farmLevel == 3)
                {
                    MessageBox.Show("Макс. рівень");
                }
                else
                {
                    MessageBox.Show("Не вистачає монет");
                    return;
                }
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawString($"ХП: {baseHealth}", Font, Brushes.Black, 10, 30);
            g.DrawString($"Волна: {wave}", Font, Brushes.Black, 10, 45);
        }
        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                if (RBMag.Checked)
                {
                    ...
                    {
                        MessageBox.Show("Максимальна кількість магічних башень досягнута");
                    }
                }
                else if (RBArcher.Checked)
                {
                    ...
                    if (currency >= towerCost && archerTowerCount < maxArcherTowers)
                    {
                        ...
                        archerTowerCount++; // Збільшуємо лічильник арбалетних башень
                    }
                    else if (archerTowerCount >= maxArcherTowers)
                    {
                        MessageBox.Show("Максимальна кількість арбалетних башень досягнута");
                    }
                }
                else if (RBKnight.Checked)
                {
                    ...
                    {
                        MessageBox.Show("Максимальна кількість рицарських башень досягнута");
                    }
                }
